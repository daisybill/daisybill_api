...
describe DaisybillApi::Models::Bill do
  it_behaves_like DaisybillApi::Ext::Attributes, :id, :date_of_service, :authorization_number, :status,
    ...
    :review_status, review_errors: :collection, diagnosis_codes: :collection,
  ...
  it_behaves_like DaisybillApi::Ext::CRUD, :all, :find, :create, :update, '/bills', injury_id: '/injuries'
